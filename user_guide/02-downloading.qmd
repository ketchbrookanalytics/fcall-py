...
FCA's 2024 files contain a known defect. See [ketchbrookanalytics/fcall-py#1](https://github.com/ketchbrookanalytics/fcall-py/issues/1) for details and workarounds while FCA addresses the issue.
:::
